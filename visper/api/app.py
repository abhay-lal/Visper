...
from visper.utils.github import parse_github_url
from visper.clients.github_client import GitHubAPIClient
from visper.clients.vectara_client import VectaraClient
from visper.services.gemini_enhancer import enhance_with_gemini
...
async def fetch_repository(request: RepoRequest):
    ...
    try:
        ...
        agent_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "agent_router.py")
